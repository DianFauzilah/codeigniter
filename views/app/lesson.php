		...
		<div class="flex">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb mb-0">
					<li class="breadcrumb-item"><a href="<?php echo Url::to(ArrayHelper::merge(['/stackadmin-app/course'], Yii::$app->request->get()));?>"><i class="material-icons">folder_open</i> Build a Rails 5 application from Scratch</a></li>
				</ol>
			</nav>
		</div>
		<div>
			...
			<div class="card">
				<ul class="list-group list-lessons">
					<li class="list-group-item d-flex align-items-center active">
						...
						<div>
							<a href="<?php echo Url::to(ArrayHelper::merge(['/stackadmin-app/lesson'], Yii::$app->request->get()));?>">Wireframe</a>
					...
					<li class="list-group-item d-flex align-items-center">
						...
						<div>
							<a href="<?php echo Url::to(ArrayHelper::merge(['/stackadmin-app/lesson'], Yii::$app->request->get()));?>">Design with Sketch</a>
							<div class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</div>
						</div>
					...
					<li class="list-group-item d-flex align-items-center">
						...
						<div>
							<a href="<?php echo Url::to(ArrayHelper::merge(['/stackadmin-app/lesson'], Yii::$app->request->get()));?>">Build static HTML/CSS with Bootstrap 4</a>
							<div class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</div>
						</div>
					</li>
					<li class="list-group-item d-flex align-items-center">
						...
						<div>
							<a href="<?php echo Url::to(ArrayHelper::merge(['/stackadmin-app/lesson'], Yii::$app->request->get()));?>">Rails New Application</a>
							<div class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</div>
						</div>
					</li>
					<li class="list-group-item d-flex align-items-center">
						...
						<div>
							<a href="<?php echo Url::to(ArrayHelper::merge(['/stackadmin-app/lesson'], Yii::$app->request->get()));?>">Github and push your first commit.</a>
							<div class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</div>
						</div>
					</li>
					<li class="list-group-item d-flex align-items-center">
						...
						<div>
							<a href="<?php echo Url::to(ArrayHelper::merge(['/stackadmin-app/lesson'], Yii::$app->request->get()));?>">Add Bootstrap 4 to Rails</a>
							<div class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</div>
						</div>
					</li>
					<li class="list-group-item d-flex align-items-center">
						...
						<div>
							<a href="<?php echo Url::to(ArrayHelper::merge(['/stackadmin-app/lesson'], Yii::$app->request->get()));?>">Include Designed SASS assets</a>
							<div class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</div>
						</div>
					</li>
					<li class="list-group-item d-flex align-items-center">
						...
						<div>
							<a href="<?php echo Url::to(ArrayHelper::merge(['/stackadmin-app/lesson'], Yii::$app->request->get()));?>">Basics of Routing</a>
							<div class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</div>
						</div>
					</li>
					<li class="list-group-item d-flex align-items-center">
						...
						<div>
							<a href="<?php echo Url::to(ArrayHelper::merge(['/stackadmin-app/lesson'], Yii::$app->request->get()));?>">Postgres Database</a>
							<div class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</div>
						</div>
					</li>
				</ul>
