...
\themes\stackadmin\assets\JQVMapPluginAsset::register($this);
$this->registerJsFile($themeAsset->baseUrl . '/js/settings.js', ['depends' => [ThemePluginAsset::className()]]);
$this->registerJsFile($themeAsset->baseUrl . '/demo/data/mall-map.js', ['depends' => [ThemePluginAsset::className()]]);
$this->registerJsFile($themeAsset->baseUrl . '/demo/data/gdp-data.js', ['depends' => [ThemePluginAsset::className()]]);
$this->registerJsFile($themeAsset->baseUrl . '/demo/js/vector-maps.js', ['depends' => [ThemePluginAsset::className()]]);
?>
