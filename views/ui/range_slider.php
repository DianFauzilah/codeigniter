...
\themes\stackadmin\assets\IonRangeSliderPluginAsset::register($this);
$this->registerCssFile($themeAsset->baseUrl . '/demo/css/ion-rangeslider.css', ['depends' => [ThemePluginAsset::className()]]);
$this->registerCssFile($themeAsset->baseUrl . '/demo/css/ion-rangeslider.rtl.css', ['depends' => [ThemePluginAsset::className()]]);
$this->registerJsFile($themeAsset->baseUrl . '/demo/js/ion-rangeslider.js', ['depends' => [ThemePluginAsset::className()]]);
?>
