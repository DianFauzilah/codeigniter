...
\themes\stackadmin\assets\InputMaskPluginAsset::register($this);
\themes\stackadmin\assets\QuillPluginAsset::register($this);
\themes\stackadmin\assets\DropzonePluginAsset::register($this);
\themes\stackadmin\assets\Select2PluginAsset::register($this);
...
$this->registerCssFile($themeAsset->baseUrl . '/demo/css/quill.css', ['depends' => [ThemePluginAsset::className()]]);
$this->registerCssFile($themeAsset->baseUrl . '/demo/css/quill.rtl.css', ['depends' => [ThemePluginAsset::className()]]);
$this->registerJsFile($themeAsset->baseUrl . '/demo/js/quill.js', ['depends' => [ThemePluginAsset::className()]]);
$this->registerCssFile($themeAsset->baseUrl . '/demo/css/dropzone.css', ['depends' => [ThemePluginAsset::className()]]);
$this->registerCssFile($themeAsset->baseUrl . '/demo/css/dropzone.rtl.css', ['depends' => [ThemePluginAsset::className()]]);
$this->registerJsFile($themeAsset->baseUrl . '/demo/js/dropzone.js', ['depends' => [ThemePluginAsset::className()]]);
$this->registerCssFile($themeAsset->baseUrl . '/demo/css/select2.css', ['depends' => [ThemePluginAsset::className()]]);
$this->registerCssFile($themeAsset->baseUrl . '/demo/css/select2.rtl.css', ['depends' => [ThemePluginAsset::className()]]);
$this->registerJsFile($themeAsset->baseUrl . '/demo/js/select2.js', ['depends' => [ThemePluginAsset::className()]]);
?>
...
<div class="card card-form">
	<div class="row no-gutters">
		...
		<div class="col-lg-8 card-form__body card-body d-flex align-items-center">
			...
			<div class="dropzone dropzone-multiple w-100" data-toggle="dropzone" data-dropzone-multiple data-dropzone-url="http://" data-dropzone-files='["<?php echo $themeAsset->baseUrl;?>/demo/images/blue.svg", "<?php echo $themeAsset->baseUrl;?>/demo/images/demi.png", "<?php echo $themeAsset->baseUrl;?>/demo/images/green.svg"]'>
				...
				<ul class="dz-preview dz-preview-multiple list-group list-group-flush">
					<li class="list-group-item">
						<div class="form-row align-items-center">
							<div class="col-auto">
								<div class="avatar">
									<img src="<?php echo $themeAsset->baseUrl;?>/demo/images/blue.svg" class="avatar-img rounded" alt="..." data-dz-thumbnail>
								</div>
							</div>
							<div class="col">
		...
		<div class="col-lg-8 card-form__body card-body">
			...
			<div class="form-group">
				...
				<select id="select02" data-toggle="select" data-minimum-results-for-search="-1" class="form-control">
					<option data-avatar-src="<?php echo $themeAsset->baseUrl;?>/demo/images/256_rsz_1andy-lee-642320-unsplash.jpg">
						Adelle Sherley
					</option>
					<option data-avatar-src="<?php echo $themeAsset->baseUrl;?>/demo/images/demi.png">
						Adrian Demian
					</option>
					<option data-avatar-src="<?php echo $themeAsset->baseUrl;?>/demo/images/green.svg">
						Green Doe
					</option>
				</select>
			</div>
