...
<body class="<?php echo $this->subLayout == 'fluid' ? 'layout-fluid layout-sticky-subnav' : ($this->subLayout == 'fixed' ? 'layout-fixed' : ($this->subLayout == 'mini' ? 'layout-mini' : 'layout-default'));?>">
<?php $this->beginBody();?>
