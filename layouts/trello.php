...
<body class="<?php echo $this->subLayout == 'fluid' ? 'layout-fluid layout-sticky-subnav' : ($this->subLayout == 'fixed' ? 'layout-fixed' : ($this->subLayout == 'mini' ? 'layout-mini' : 'layout-default'));?> trello">
<?php $this->beginBody();?>
...
<?php }?>
			...
			<div class="<?php echo in_array($this->subLayout, ['fluid','fixed']) ? 'mdk-header-layout__content' : 'mdk-drawer-layout__content';?> page">
				...
				<div class="trello-container">
					<div class="trello-board <?php echo in_array($this->subLayout, ['fixed','mini']) ? 'container' : 'container-fluid';?> page__container">
						<?php echo $content; ?>
					</div>
				</div>
			</div>
