                            ...
                            <ul class="nav navbar-nav">
                                <li class="nav-item dropdown active">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item active" href="fixed-dashboard.html">Default</a>
                                        <a class="dropdown-item" href="fixed-staff.html">CRM/Staff</a>
                                        <a class="dropdown-item" href="fixed-analytics.html">E-commerce Analytics</a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="fixed-app-fullcalendar.html">Event Calendar</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="fixed-stories.html">Stories</a>
                                        ...
                                        <a class="dropdown-item" href="fixed-digital-product.html">Digital Product</a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="fluid-dashboard.html">Full Width Navs</a>
                                        <a class="dropdown-item active" href="fixed-dashboard.html">Fixed Navs</a>
