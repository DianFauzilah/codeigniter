                        ...
                        <div class="bg-primary" style="min-height: 150px;">
                            <div class="d-flex align-items-end container-fluid page__container" style="position: absolute; left: 0; right: 0; bottom: 0;">
                                <div class="avatar avatar-xl">
                                    <img src="<?php echo base_url('assets/images/avatar/demi.png')?>" alt="avatar" class="avatar-img rounded" style="border: 2px solid white;">
                                </div>
                                                ...
                                                <div class="d-flex mb-1">
                                                    ...
                                                    <div class="flex">
                                                        ...
                                                        <a href="" class="card my-3 text-body decoration-0">
                                                            <img src="<?php echo base_url('assets/images/choose/demo1.png')?>" alt="image" class="rounded card-img-top">
                            ...
                            <div class="d-flex align-items-center sidebar-p-a border-bottom sidebar-account">
                                ...
                                <div class="dropdown ml-auto">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item active" href="profile.html">My profile</a>
