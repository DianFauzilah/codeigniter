                            ...
                            <ul class="nav navbar-nav">
                                <li class="nav-item dropdown active">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item active" href="fluid-dashboard.html">Default</a>
                                        <a class="dropdown-item" href="fluid-staff.html">CRM/Staff</a>
                                        <a class="dropdown-item" href="fluid-analytics.html">E-commerce Analytics</a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown">
                                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Apps</a>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="fluid-app-trello.html">Trello</a>
                                        <a class="dropdown-item" href="fluid-app-projects.html">Projects</a>
                                        <a class="dropdown-item" href="fluid-app-fullcalendar.html">Event Calendar</a>
                                        <a class="dropdown-item" href="fluid-app-chat.html">Chat</a>
                                        <div class="dropdown-divider"></div>
                                        <div class="dropdown-header">Education</div>
                                        <a class="dropdown-item" href="fluid-app-course.html">Course</a>
                                        <a class="dropdown-item" href="fluid-app-lesson.html">Lesson</a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown">
                                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Pages</a>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="fluid-stories.html">Stories</a>
                                        <a class="dropdown-item" href="fluid-invoice.html">Invoice</a>
                                        <a class="dropdown-item" href="fluid-pricing.html">Pricing</a>
                                        <a class="dropdown-item" href="fluid-edit-account.html">Edit Account</a>
                                        <a class="dropdown-item" href="fluid-profile.html">Profile</a>
                                        <a class="dropdown-item" href="login.html">Login</a>
                                        <a class="dropdown-item" href="signup.html">Sign Up</a>
                                        <a class="dropdown-item" href="fluid-digital-product.html">Digital Product</a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item active" href="fluid-dashboard.html">Full Width Navs</a>
                                        <a class="dropdown-item" href="fixed-dashboard.html">Fixed Navs</a>
                                        <a class="dropdown-item" href="mini-dashboard.html">Mini Sidebar + Navs</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
    ...
    <!-- App Settings FAB -->
    <div id="app-settings">
        <app layout-active="fluid" :layout-location="{
      'default': 'index.html',
                ...
                <div class="d-flex align-items-center sidebar-p-a border-bottom sidebar-account">
                    ...
                    <div class="dropdown ml-auto">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item active" href="fluid-dashboard.html">Dashboard</a>
                            <a class="dropdown-item" href="fluid-profile.html">My profile</a>
                            <a class="dropdown-item" href="fluid-edit-account.html">Edit account</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="fluid-login.html">Logout</a>
                        </div>
                    </div>
                </div>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <ul class="sidebar-submenu collapse" id="apps_menu">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="fluid-app-fullcalendar.html">
                            ...
                            <li class="sidebar-menu-item ">
                                ...
                                <ul class="sidebar-submenu collapse " id="course_menu">
                                    <li class="sidebar-menu-item ">
                                        <a class="sidebar-menu-button" href="fluid-app-course.html">
                                            <span class="sidebar-menu-text">Course</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item ">
                                        <a class="sidebar-menu-button" href="fluid-app-lesson.html">
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <ul class="sidebar-submenu collapse" id="pages_menu">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="fluid-invoice.html">
                                    <span class="sidebar-menu-text">Invoice</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="fluid-pricing.html">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="fluid-profile.html">
                                    <span class="sidebar-menu-text">User Profile</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="fluid-digital-product.html">
