                    ...
                    <div class="container-fluid page__container">
                        ...
                        <div class="stories-cards mb-4">
                            ...
                            <div class="card stories-card">
                                <div class="stories-card__content d-flex align-items-center flex-wrap">
                                    <div class="avatar avatar-lg mr-3">
                                        <a href=""><img src="<?php echo base_url('assets/images/stories/256_rsz_clem-onojeghuo-193397-unsplash.jpg')?>" alt="avatar" class="avatar-img rounded"></a>
                                    </div>
                            ...
                            <div class="card stories-card">
                                <div class="stories-card__content d-flex align-items-center flex-wrap">
                                    <div class="avatar avatar-lg mr-3">
                                        <a href=""><img src="<?php echo base_url('assets/images/stories/256_rsz_dex-ezekiel-761373-unsplash.jpg')?>" alt="avatar" class="avatar-img rounded"></a>
                                    </div>
                                    <div class="stories-card__title flex">
                            ...
                            <div class="card stories-card">
                                <div class="stories-card__content d-flex align-items-center flex-wrap">
                                    <div class="avatar avatar-lg mr-3">
                                        <a href=""><img src="<?php echo base_url('assets/images/stories/256_rsz_rhema-kallianpur-275251-unsplash.jpg')?>" alt="avatar" class="avatar-img rounded"></a>
                                    </div>
                                    <div class="stories-card__title flex">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="card stories-card-popular">
                                    <img src="<?php echo base_url('assets/images/stories/256_rsz_euan-carmichael-666378-unsplash.jpg')?>" alt="" class="card-img">
                                    <div class="stories-card-popular__content">
                                        <div class="card-body d-flex align-items-center">
                                            <div class="avatar-group flex">
                                                <div class="avatar avatar-xs">
                                                    <a href=""><img src="<?php echo base_url('assets/images/256_luke-porter-261779-unsplash.jpg')?>" alt="Avatar" class="avatar-img rounded-circle"></a>
                                                </div>
                                            </div>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="card stories-card-popular">
                                    <img src="<?php echo base_url('assets/images/stories/256_rsz_jared-rice-388260-unsplash.jpg')?>" alt="" class="card-img">
                                    <div class="stories-card-popular__content">
                                        <div class="card-body d-flex align-items-center">
                                            <div class="avatar-group flex">
                                                <div class="avatar avatar-xs">
                                                    <a href=""><img src="<?php echo base_url('assets/images/256_michael-dam-258165-unsplash.jpg')?>" alt="Avatar" class="avatar-img rounded-circle"></a>
                                                </div>
                                            </div>
                                            <a style="text-decoration: none;" class="d-flex align-items-center" href=""><i class="material-icons mr-1" style="font-size: inherit;">remove_red_eye</i> <small>327</small></a>
                                        </div>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="card stories-card-popular">
                                    <img src="<?php echo base_url('assets/images/stories/256_rsz_dex-ezekiel-761373-unsplash.jpg')?>" alt="" class="card-img">
                                    <div class="stories-card-popular__content">
                                        <div class="card-body d-flex align-items-center">
                                            <div class="avatar-group flex">
                                                <div class="avatar avatar-xs">
                                                    <a href=""><img src="<?php echo base_url('assets/images/256_rsz_1andy-lee-642320-unsplash.jpg')?>" alt="Avatar" class="avatar-img rounded-circle"></a>
                                                </div>
                                            </div>
                                            <a style="text-decoration: none;" class="d-flex align-items-center" href=""><i class="material-icons mr-1" style="font-size: inherit;">remove_red_eye</i> <small>327</small></a>
                                        </div>
