                                    ...
                                    <div data-simplebar class="h-100">
                                        ...
                                        <div class="media border-bottom py-3">
                                            <a href="#" class="avatar avatar-sm mr-3">
                                                <img src="<?php echo base_url('assets/images/256_rsz_1andy-lee-642320-unsplash.jpg')?>" class="avatar-img rounded-circle" alt="avatar">
                                            </a>
                                        ...
                                        <div class="media border-bottom py-3">
                                            <a href="#" class="avatar avatar-sm mr-3">
                                                <img src="<?php echo base_url('assets/images/256_daniel-gaffey-1060698-unsplash.jpg')?>" class="avatar-img rounded-circle" alt="avatar">
                                            </a>
                                            <div class="media-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex">
                                                ...
                                                <a href="" class="avatar avatar-xxl avatar-4by3 mt-2">
                                                    <img src="<?php echo base_url('assets/images/stories/256_rsz_dex-ezekiel-761373-unsplash.jpg')?>" alt="image" class="avatar-img rounded">
                                                </a>
                                        ...
                                        <div class="media border-bottom py-3">
                                            <a href="#" class="avatar avatar-sm mr-3">
                                                <img src="<?php echo base_url('assets/images/256_jeremy-banks-798787-unsplash.jpg')?>" class="avatar-img rounded-circle" alt="avatar">
                                            </a>
                                            <div class="media-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex">
                                        ...
                                        <div class="media border-bottom py-3">
                                            <a href="#" class="avatar avatar-sm mr-3">
                                                <img src="<?php echo base_url('assets/images/256_joao-silas-636453-unsplash.jpg')?>" class="avatar-img rounded-circle" alt="avatar">
                                            </a>
                                            <div class="media-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex">
                                        ...
                                        <div class="media border-bottom py-3">
                                            <a href="#" class="avatar avatar-sm mr-3">
                                                <img src="<?php echo base_url('assets/images/256_luke-porter-261779-unsplash.jpg')?>" class="avatar-img rounded-circle" alt="avatar">
                                            </a>
                                            <div class="media-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex">
                                        ...
                                        <div class="media py-3">
                                            <a href="#" class="avatar avatar-sm mr-3">
                                                <img src="<?php echo base_url('assets/images/256_michael-dam-258165-unsplash.jpg')?>" class="avatar-img rounded-circle" alt="avatar">
                                            </a>
                                            <div class="media-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex">
