                            ...
                            <div class="flex">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb mb-0">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">StackDash</li>
                                    </ol>
                                </nav>
                                <h1 class="m-0">StackDash - Bootstrap 4 Admin Dashboard</h1>
                            </div>
                            <a href="" class="btn btn-success ml-3">Purchase</a>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid page__container">
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <p>StackDash is the easiest way to build or style your dashboard/application. We’ve removed the design hassle while providing hundreds of beautiful customizable ui components along with multiple dashboards, apps & pages.</p>
                                <p>The StackDash admin theme features over 35+ apps & pages built using various html components. All components in our theme can be modified through their source SASS and JS files.</p>
