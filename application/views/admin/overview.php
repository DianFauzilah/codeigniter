<!-- PHP HEADER -->
          ...
          <div class="container-fluid page__container">
            ...
            <div class="alert alert-soft-warning d-flex align-items-center card-margin" role="alert">
              ...
              <div class="text-body"><strong>API gateways are now Offline.</strong> Please try the API later. If you
                want to stay up to date follow our <a href="">Status Page </a></div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-5">
                <div class="card">
                  ...
                  <div class="card-body">
                    <div id="vector-map-revenue" class="map mb-3" data-toggle="vector-map"
                      data-vector-map-map="world_en" data-vector-map-show-tooltip="false"
                      data-vector-map-enable-zoom="true" data-vector-map-scale="1.1" data-vector-map-pins='{
                      ...
                      <li data-toggle="vector-map-focus" data-target="#vector-map-revenue" data-focus="it"
                        ...
                        <div class="dashboard-location-tabs__tab" data-toggle="tab" role="tab" aria-selected="true">
                          ...
                          <div class="d-flex align-items-center">
                            <div class="flex mr-2">
                              <div class="progress" style="height: 6px;">
                                <div class="progress-bar bg-primary" role="progressbar" style="width: 39%;"
                    ...
                    <div class="tab-pane active show fade" id="activity_all">
                        ...
                        <div class="flex">
                          <div class="d-flex align-items-middle">
                            <div class="avatar avatar-xxs mr-1">
                              <img src="<?php echo base_url('assets/images/256_rsz_1andy-lee-642320-unsplash.jpg')?>"
                      ...
                      <div class="list-group-item list-group-item-action d-flex align-items-center ">
                        ...
                        <div class="flex">
                          <div class="d-flex align-items-middle">
                            <div class="avatar avatar-xxs mr-1">
                              <img src="<?php echo base_url('assets/images/256_daniel-gaffey-1060698-unsplash.jpg')?>"
                                alt="Avatar" class="avatar-img rounded-circle">
                            </div>
                      ...
                      <div class="list-group-item list-group-item-action d-flex align-items-center  bg-light ">
                        ...
                        <div class="flex">
                          <div class="d-flex align-items-middle">
                            <div class="avatar avatar-xxs mr-1">
                              <img src="<?php echo base_url('assets/images/256_jeremy-banks-798787-unsplash.jpg')?>"
                                alt="Avatar" class="avatar-img rounded-circle">
                            </div>
                      ...
                      <div class="list-group-item list-group-item-action d-flex align-items-center  bg-light ">
                        ...
                        <div class="flex">
                          <div class="d-flex align-items-middle">
                            <div class="avatar avatar-xxs mr-1">
                              <img src="<?php echo base_url('assets/images/256_joao-silas-636453-unsplash.jpg')?>"
                                alt="Avatar" class="avatar-img rounded-circle">
                            </div>
                      ...
                      <div class="list-group-item list-group-item-action d-flex align-items-center  bg-light ">
                        ...
                        <div class="flex">
                          <div class="d-flex align-items-middle">
                            <div class="avatar avatar-xxs mr-1">
                              <img src="<?php echo base_url('assets/images/256_luke-porter-261779-unsplash.jpg')?>"
                                alt="Avatar" class="avatar-img rounded-circle">
                            </div>
                    ...
                    <div class="tab-pane" id="activity_purchases">
                      ...
                      <div class="list-group-item list-group-item-action d-flex align-items-center  bg-light ">
                        ...
                        <div class="flex">
                          <div class="d-flex align-items-middle">
                            <div class="avatar avatar-xxs mr-1">
                              <img src="<?php echo base_url('assets/images/256_michael-dam-258165-unsplash.jpg')?>"
                                alt="Avatar" class="avatar-img rounded-circle">
                            </div>
              ...
              <div class="col-lg">
                <div class="card">
                    ...
                    <ul class="list-unstyled list-todo" id="todo">
                      <li>
                        <div class="custom-control custom-checkbox">
                          ...
                          <label class="custom-control-label" for="customCheck1">Wireframe the CRM application
                            pages</label>
                        </div>
                      </li>
                      <li>
                      ...
                      <li>
                        <div class="custom-control custom-checkbox">
                          ...
                          <label class="custom-control-label" for="customCheck4">Interview John for Full-Stack
                            Developer</label>
                        </div>
                      </li>
                      <li>
                  ...
                  <div class="card-footer text-center">
                    15 <span class="text-muted">of 100</span> <a href="#"><i
                        class="material-icons icon-muted float-right">arrow_forward</i></a>
                  </div>
                </div>
              </div>
              <div class="col-lg">
                  ...
                  <div class="card-body">
                    <ul class="list-unstyled list-skills">
                      ...
                      <li>
                        ...
                        <div class="flex">
                          <div class="progress" style="height: 6px;">
                            <div class="progress-bar bg-dark-gray" role="progressbar" style="width: 76%;"
